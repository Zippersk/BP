...
\begin{document}
  ...
  %\input{chapters/projekt-01-uvod}
              ...
              \subfile{chapters/fitcrack}
              \subfile{chapters/technologie}
              \subfile{chapters/navrh}
              %\subfile{chapters/openapispec}
              \subfile{chapters/implementacia}
              \subfile{chapters/zaver}
